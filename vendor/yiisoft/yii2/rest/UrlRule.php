 ...
 * You may configure [[controller]] with multiple controller IDs to generate rules for all these rest.
 * For example, the following code will disable the `delete` rule and generate rules for both `user` and `post` rest:
 *
 * ```php
 * [
 *     'class' => 'yii\rest\UrlRule',
...
class UrlRule extends CompositeUrlRule
{
    ...
    /**
     * @var boolean whether to automatically pluralize the URL names for rest.
