...
class Module extends ServiceLocator
{
     ...
     * ```php
     * [
     *   'account' => 'app\rest\UserController',
     *   'article' => [
     *      'class' => 'app\rest\PostController',
     ...
     * class name.
     *
     * If not set, it will use the `rest` sub-namespace under the namespace of this module.
     * For example, if the namespace of this module is "foo\bar", then the default
     * controller namespace would be "foo\bar\rest".
     *
    ...
    public function init()
    {
        if ($this->controllerNamespace === null) {
            ...
            if (($pos = strrpos($class, '\\')) !== false) {
                $this->controllerNamespace = substr($class, 0, $pos) . '\\rest';
            }
        }
    }
